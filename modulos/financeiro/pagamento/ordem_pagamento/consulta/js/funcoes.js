...
corpo.addEventListener("load", pesquisarProd(pagina, 6, nop, cliente, iemissao, femissao));
function pesquisarProd(pagina, qnt_result_pg,  nop, cliente, iemissao, femissao){
    if(nop == undefined){
    ...
    function listar(dados){
        fetch('/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/consulta/controllers/listar.php',{
            method: 'POST',
    ...
    function editarOP(id){
        window.location.href = "/owlsoftware/modulos/index.php?pag=OP&id="+id;
