$(document).ready(function($){
    ...
    $("#cpfcnpj").keydown(function(){
        ...
        var elem = this;
        setTimeout(function(){
            // mudo a posição do seletpagamentoOP
            elem.selectionStart = elem.selectionEnd = 10000;
        }, 0);
        // reaplico o valpagamentoOP para mudar o foco
...
function buscarClie(cod){
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/bClienteE.php",{
        method: "POST",
...
function carregaDados(){
    ...
    if(id != ''){
        ...
        fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/carregaOP.php" , {
            method: "POST",
            body: JSON.stringify(dados),
            headers: {'Content-Type': 'application/json'}}
        ).then(function(response){
            ...
            setTimeout(() => {
                ...
                document.getElementById("nop").value = p[0];
                document.getElementById("seqnop").value = p[1];
                buscarClie(p[2]);
                ...
                document.getElementById("conta").value = p[9];
    ...
    if(document.getElementById("nop").value == ''){
        console.log("oi1");
        document.getElementById("verComentario").title = "Desabilitado. É necessário abrir uma ordem de pagamento para visualizar comentário.";
...
function pesquisarCli(){
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/bClienteModal.php",{
        method: "POST",
        body: JSON.stringify(dados),
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
...
function confirmar(){
    ...
    var seqnop = document.getElementById("seqnop").value;
    ...
    if(nop !=''){
        ...
        if(cliente == '' || emissao == '' || valor == '' || condicao == '#' || formapag == '#'){
            ...
            console.log(dados)
            fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/ordemPagamento.php",{
                method: "POST",
                body: JSON.stringify(dados),
                headers: {'Content-Type': 'application/json'}
            }).then(function(response){
                ...
                alert(resultado[0]);
                window.location.href = "/owlsoftware/modulos/index.php?pag=OP&id="+resultado[1];
            }).catch(function(error){
                alert(error);
            })
...
function atualizar(){
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/aParcela.php",{
        method: "POST",
        body: JSON.stringify(dados),
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
...
function carregaParcelas(id){
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/cParcelas.php",{
        method: "POST",
        body: JSON.stringify(dados),
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
...
function pesquisar(){
    window.location.href = "/owlsoftware/modulos/index.php?pag=busca_op"
}
...
function editar(id){
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/editarParcela.php",{
        method: "POST",
        body: JSON.stringify(dados),
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
        ...
        console.log(p[11]);
        (p[11] == 1)? document.getElementById("valorParcela").disabled =false : document.getElementById("valorParcela").disabled ="true";
        document.getElementById("condpag").value = p[7];
        document.getElementById("condpag").disabled = true;
        document.getElementById("formapag").value = p[8];
        document.getElementById("formapag").disabled = true;
        document.getElementById("observacoes").value = p[10];
    }).catch(function(error){
        console.log(error);
    })
...
function carregaCondPag(){
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/bCondPag.php",{
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
        return response.text();
    }).then(function(text){
...
function carregaFormaPag(){
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/bFormaPag.php",{
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
        return response.text();
    }).then(function(text){
...
function cliente(cod){
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/bCliente.php",{
        method: "POST",
        body: JSON.stringify(dados),
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
...
function limpar(){
    window.location.href = "/owlsoftware/modulos/index.php?pag=OP";
}

function validaCancelamento(){
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/validaSenhaCancelamento.php",{
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
        return response.text();
    }).then(function(text){
...
function cancelar(){
    ...
    var dados = {};
    if(nop ==''){
        alert("É necessário estar com uma ordem de pagamento aberta para efetuar o cancelamento. ");
        return;
    }else{
        if(selecionada){
            dados = {
    ...
    fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/cancelarOP.php",{
        method: "POST",
        body: JSON.stringify(dados),
        headers: {'Content-Type': 'application/json'}
    }).then(function(response){
...
function verificaComentario(){
    if(document.getElementById("nop").value == ''){
        alert("Selecione uma ordem de pagamento para visualizar os comentários.");
    }else{
        carregaComentario();
    }
}
function carregaComentario(){
    var nop  = document.getElementById("nop").value;
        ...
        var dados = {nop: nop};
        fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/carregaComentario.php",{
            method: "POST",
            body: JSON.stringify(dados),
            headers: {'Content-Type': 'application/json'}
        }).then(function(response){
            ...
            if(text == 0){
                dvTab.innerHTML = "<div class='alert alert-danger' role='alert'>Nenhum comentário localizado para a ordem de pagamento.</div>";
            }else{
...
function addComentario(){
    ...
    if(comentario == ''){
        ...
        fetch("/owlsoftware/modulos/financeiro/pagamento/ordem_pagamento/controller/addComentario.php",{
            method: "POST",
            body: JSON.stringify(dados),
            headers: {'Content-Type': 'application/json'}
        }).then(function(response){
