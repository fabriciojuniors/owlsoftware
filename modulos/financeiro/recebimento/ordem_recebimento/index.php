...
<head>
  ...
  <script src="/owlsoftware/modulos/financeiro/recebimento/ordem_recebimento/js/funcoes.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js"></script>  
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  <title>Ordem de Recebimento</title>
</head>
<style>
...
<div id="conteudo" style="display: block;">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">Ordem de Recebimento</h1>
    ...
    <div class="conteudo">
      <div class="esquerda">
        <div class="form-group">
            <label for="">N° Ordem de Recebimento</label>
            <div class="row" style="margin-left: 1px;">
                <input type="text" disabled class="form-control campos" style="width: 80px; margin-right:10px ;" id="nor"> 
                <p>/</p>
                <input type="text" disabled class="form-control campos" style="width: 80px; margin-left: 10px;" id="seqnor">
            </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="date" name="" style="width: 150px;" value="<?php echo date("Y-m-d"); ?>" id="emissao" class="form-control campos campoDate">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3" style="width: 250px;">
            ...
            <input type="text" data-mask = "000.000.000.000,00" data-mask-reverse = "true"  id="valorTot" class="form-control campos">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3" style="width: 250px;">
            ...
            <input type="text" data-mask = "000.000.000.000,00" data-mask-reverse="true" value="0,00" disabled id="valorParcela" class="form-control campos">
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="direita">
        ...
        <div style="display: none" class="form-group">
          ...
          <select name="" id="sconta" class="form-control campos">
            <option value="#">Selecione</option>
          </select>
        </div>
        <div class="form-group">
...
<div class="modal fade" id="modalCancelamento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cancelar ordem de Recebimento</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
