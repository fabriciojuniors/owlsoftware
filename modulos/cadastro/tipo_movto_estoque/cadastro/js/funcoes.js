...
function infos(){
    fetch("/owlsoftware/modulos/cadastro/grupo_produto/cadastro/controller/data.php")
...
function confirmar(){
    ...
    if(descricao == '' || operador ==  ''){
        ...
        fetch("/owlsoftware/modulos/cadastro/tipo_movto_estoque/cadastro/controller/cadastrar.php", {
            method: "POST",
