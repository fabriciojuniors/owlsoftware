...
listar(pagina, qnt_result_pg);
    ...
    function listar(pagina, qnt_result_pg){
        ...
        fetch('/owlsoftware/modulos/cadastro/condicao_pagamento/consulta/controllers/listar.php',{
            method: 'POST',
    ...
    function editar(id, cod, descricao, inativo, usuario, data, parcela_minima, parcela_maxima, condicao){
        ...
        document.getElementById("parcela_minima").value = parcela_minima;
        document.getElementById("parcela_maxima").value = parcela_maxima;
        document.getElementById("condicao").value = condicao;
    } 