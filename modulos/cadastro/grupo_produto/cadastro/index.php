...
<head>
  ...
  <script src="/owlsoftware/modulos/cadastro/grupo_produto/cadastro/js/funcoes.js"></script>
  <script src="/owlsoftware/modulos/cadastro/grupo_produto/consulta/js/funcoes.js"></script>
...
<div id="conteudo" style="display: block;">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">Grupo de Produto</h1>
      ...
      <div class="row">
        <div class="col">
          <div class="custom-control custom-checkbox my-1 mr-sm-2">
            <input type="checkbox" class="custom-control-input" id="venda">
            <label class="custom-control-label" for="venda">Grupo de Venda</label>
          </div>
        </div>
        <div class="col">
