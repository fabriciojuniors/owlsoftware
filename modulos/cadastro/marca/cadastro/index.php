...
<head>
  ...
  <script src="/owlsoftware/modulos/cadastro/marca/cadastro/js/funcoes.js"></script>
  <script src="/owlsoftware/modulos/cadastro/marca/consulta/js/funcoes.js"></script>
...
<div id="conteudo" style="display: block;">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">Marca</h1>
