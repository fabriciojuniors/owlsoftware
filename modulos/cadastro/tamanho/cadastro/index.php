...
<head>
  ...
  <script src="/owlsoftware/modulos/cadastro/tamanho/cadastro/js/funcoes.js"></script>
  <script src="/owlsoftware/modulos/cadastro/tamanho/consulta/js/funcoes.js"></script>
...
<div id="conteudo" style="display: block;">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">Tamanho</h1>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" id="codigo" name="cod" disabled style="width: 150px; height: 30px;" class="form-control">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="">Criação</label>
                    <input type="date" id="dt_criacao" value="<?php echo date('Y-m-d');?>" name="dt_criacao" disabled style="width: 200px; height: 30px;" class="form-control">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="date" value="<?php echo date('Y-m-d');?>" id="dt_atualizacao" name="dt_atualizacao" disabled style="width: 200px; height: 30px;" class="form-control">
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" value="0,00" onkeyup="formatarMoeda(this)" style="width: 200px; height: 30px;" class="form-control" id="altura">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="">Largura (cm)</label>
                            <input type="text" value="0,00" onkeyup="formatarMoeda(this)" style="width: 200px; height: 30px;" class="form-control" id="largura">
                        </div>
                    </div>
                </div>
            </div>
