...
function infos(){
    fetch("/owlsoftware/modulos/cadastro/origem_estoque/cadastro/controller/data.php")
...
function confirmar(){
    ...
    if(descricao == ''){
        ...
        fetch("/owlsoftware/modulos/cadastro/origem_estoque/cadastro/controller/cadastrar.php", {
            method: "POST",
