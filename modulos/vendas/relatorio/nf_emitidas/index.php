...
<head>
    ...
    <script src="/owlsoftware/modulos/vendas/relatorio/nf_emitidas/js/gerar.js"></script>
    <script src="/owlsoftware/modulos/vendas/relatorio/nf_emitidas/js/funcoes.js"></script>
    <title>Rel. Notas Fiscais Emitidas</title>
</head>
<body>
    <h4>Rel. Notas Fiscais Emitidas por Período "Elegante"</h4>
    <form class="" action="/owlsoftware/modulos/vendas/relatorio/nf_emitidas/controller/relFat01.php" onsubmit="target_popup(this)" method="post">
          <label for="">Emissão</label>
            ...
            <div class="row">
                <div class="col-md-auto" style="padding-right: 0%">
                    <input type="date" required name="ientrega" value="<?php echo date("Y-m-d", strtotime('-30 days')); ?>" id="ientrega" class="form-control campos">
                </div>
                <div class="col-md-auto" >até</div>
                <div class="col-md-auto" style="padding: 0%">
                    <input type="date"required name="fentrega" value="<?php echo date("Y-m-d"); ?>" id="fentrega" class="form-control campos">
                </div>
            </div>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($query)>0){
                        while($row = mysqli_fetch_array($query)){
                            ?>
                              <a class="dropdown-item"> <input checked class="dropdown-item" value="<?php echo $row['id'];?>" type="checkbox" name="tpVenda<?php echo $row['id']; ?>" id="tpVenda<?php echo $row['id']; ?>"> <?php echo $row['descricao'];?> </a>
                            <?php
                        }
                    }
                ?>
