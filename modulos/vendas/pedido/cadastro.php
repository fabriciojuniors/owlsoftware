<div class="row" style="margin-top: 1%">
          <div class="col">
            <div class="form-group">
                ...
                <input type="text" readonly class="form-control campos" style="width: 85px" id="numPedido">
            </div>   
            <div class="form-group">
                ...
                <select name="tpVenda" id="tpVenda" class="form-control campos">
                    ...
                    <?php
                        $sql = "SELECT * FROM tp_venda WHERE inativo = 0 AND devolucao = 0";
          ...
          <div class="col">
            <div class="form-group">
                ...
                <input type="date" name="" value="<?php echo date("Y-m-d"); ?>" id="emissao" class="form-control campos">
            </div>
            <div class="form-group">
