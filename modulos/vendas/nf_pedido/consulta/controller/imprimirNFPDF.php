        ...
        if(isset($nota)){
            ...
            <div class="row">
                <div class="col-md-auto">
                    <img src="/owlsoftware/modulos/adm/empresa/logo/'.$empresa['logo'].'" style="width: 150px; height: 150px" alt="Não foi possível carregar a logo">
                </div>
                <div class="col">
                    <p> 
                        <strong>Razão Social:</strong>'.  $empresa['razao'] .'<br>
                        <strong>Nome Fantasia:</strong>'. $empresa['fantasia'].' <br> 
                        <strong>CNPJ:</strong>'.$empresa['cnpj'].' <br>
                        <strong>Inscrição Estadual:</strong> '.$empresa['ie'].'  
                    </p>
                </div>
                <div class="col-md">
                    <p>
                        <strong>Nota: </strong>'.$notaFiscal['numero'].' <br>
                        <strong>Emissão: </strong>'.date("d/m/Y", strtotime($notaFiscal['emissao'])).'<br>
                ...
                for ($i=0; $i < $parcelas; $i++) { 
                    $parcela = mysqli_fetch_array($queryFinanceiro);
                        $html .='                    
                            <div class="col">
                                <p>
                                    <strong>Número:</strong> '.$parcela['numero'].' <br>
